...
export default function Servicios() {
  ...
  return (
    <div className="min-h-screen">
      {/* Nav */}
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-[#0f2847]/10">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/servicios" className="text-sm font-semibold text-[#c5a044]">Servicios</Link>
            <Link href="/cursos" className="text-sm font-semibold hover:text-[#c5a044] transition-colors">Cursos</Link>
            <Link href="/dashboard" className="text-sm font-semibold hover:text-[#c5a044] transition-colors">Mi Portal</Link>
            <Link href="/dashboard" className="px-5 py-2.5 bg-[#0f2847] text-black font-bold rounded-lg hover:shadow-lg hover:shadow-[#0f2847]/20 transition-all">Pedir Cita</Link>
          </div>
        </div>
      </nav>
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        <header className="max-w-3xl mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#0f2847]/10 border border-[#0f2847]/20 rounded-full mb-6">
            <span className="w-2 h-2 bg-[#0f2847] rounded-full animate-pulse"></span>
            <span className="text-xs font-bold uppercase tracking-wider text-[#c5a044]">Atención Integral en Colombia</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold mb-6 leading-tight">
            Nuestras <span className="text-[#c5a044]">Especialidades</span> y Servicios Médicos
          </h1>
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 mb-12">
          <div className="relative w-full md:w-96">
            ...
            <input
              className="w-full pl-12 pr-4 py-4 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#c5a044] focus:border-transparent outline-none transition-all"
            ...
            {filtros.map((f) => (
              <button
                ...
                className={`px-6 py-3 whitespace-nowrap font-semibold rounded-xl transition-colors ${
                  filtro === f
                    ? "bg-[#0f2847] text-black font-bold"
                    : "bg-white border border-slate-200 hover:border-[#c5a044]"
                }`}
              >
                {f}
              </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {serviciosFiltrados.map((s, i) => (
            <div key={i} className="group bg-white p-8 rounded-xl border border-slate-200 hover:border-[#0f2847]/50 hover:shadow-2xl hover:shadow-[#0f2847]/5 transition-all flex flex-col">
              <div className="w-14 h-14 bg-[#0f2847]/10 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              ...
              <button className="inline-flex items-center text-sm font-bold text-black bg-[#0f2847] px-6 py-3 rounded-lg hover:bg-[#0f2847]/90 transition-colors w-fit">
                Saber más
          ...
          {/* CTA Card */}
          <div className="bg-gradient-to-br from-[#0f2847] to-blue-700 p-8 rounded-xl border-none shadow-xl flex flex-col justify-between overflow-hidden relative group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-8">
                <div className="flex items-center gap-4">
                  <div className="flex -space-x-3">
                    ...
                    <div className="w-10 h-10 rounded-full border-2 border-white bg-[#0f2847] flex items-center justify-center">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex gap-4">
                  <div className="flex-shrink-0 w-8 h-8 rounded-full bg-[#0f2847]/20 text-[#c5a044] flex items-center justify-center font-bold">{step.num}</div>
                  <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-slate-500">
                <li><a className="hover:text-[#c5a044]" href="#">Medicina General</a></li>
                <li><a className="hover:text-[#c5a044]" href="#">Psicología</a></li>
                <li><a className="hover:text-[#c5a044]" href="#">Nutrición</a></li>
                <li><a className="hover:text-[#c5a044]" href="#">Monitoreo Crónico</a></li>
              </ul>
            </div>
            <div>
              <h5 className="font-bold mb-6">Plataforma</h5>
              <ul className="space-y-4 text-sm text-slate-500">
                <li><a className="hover:text-[#c5a044]" href="#">Cómo Funciona</a></li>
                <li><a className="hover:text-[#c5a044]" href="#">Seguridad de Datos</a></li>
                <li><a className="hover:text-[#c5a044]" href="#">Soporte Técnico</a></li>
              </ul>
            </div>
            <div>
              <h5 className="font-bold mb-6">Contacto</h5>
              <ul className="space-y-4 text-sm text-slate-500">
                <li className="flex items-center gap-2"><span className="material-icons-outlined text-[#c5a044] text-sm">phone</span>+57 601 123 4567</li>
                <li className="flex items-center gap-2"><span className="material-icons-outlined text-[#c5a044] text-sm">email</span>contacto@issi.edu.co</li>
                <li className="flex items-center gap-2"><span className="material-icons-outlined text-[#c5a044] text-sm">location_on</span>Bogotá, Colombia</li>
              </ul>
            </div>
          </div>
