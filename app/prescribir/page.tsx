...
export default function Prescribir() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ fontFamily: "'Manrope', sans-serif" }}>
      {/* Header */}
      <header className="bg-white border-b border-[#0f2847]/20 px-4 lg:px-6 py-3 sticky top-0 z-50">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-base lg:text-lg tracking-tight">Prescribe<span className="text-[#c5a044]">Direct</span></span>
            <span className="hidden sm:inline-block px-2 py-0.5 bg-[#0f2847]/10 text-[#c5a044] text-[10px] font-bold uppercase rounded border border-[#0f2847]/20 ml-2">MIPRES</span>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div className="w-9 h-9 rounded-full bg-[#0f2847]/20 flex items-center justify-center text-[#c5a044] font-bold text-xs">
      ...
      <main className="flex-1 flex flex-col xl:flex-row overflow-hidden relative">
          ...
          <div className="max-w-4xl mx-auto space-y-4 lg:space-y-6">
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
              <div className="bg-slate-50 px-4 lg:px-6 py-3 border-b border-slate-200 flex justify-between items-center">
                <h3 className="text-sm font-bold flex items-center gap-2">
                  <span className="material-icons-outlined text-[#c5a044] text-lg">add_circle</span>
                  Prescripción
                </h3>
              ...
              <div className="p-4 lg:p-6 space-y-4 lg:space-y-6">
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <input className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-lg focus:ring-[#c5a044] focus:border-[#c5a044] text-sm" placeholder="Nombre del medicamento..." type="text" />
                  </div>
                </div>
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
              <div className="bg-slate-50 px-4 lg:px-6 py-3 border-b border-slate-200">
                <h3 className="text-sm font-bold flex items-center gap-2">
                  <span className="material-icons-outlined text-[#c5a044] text-lg">description</span>
                  Justificación Clínica
                </h3>
              </div>
              <div className="p-4 lg:p-6">
                <textarea className="w-full p-3 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:ring-[#c5a044]" placeholder="Describa la necesidad médica..." rows={3}></textarea>
            ...
            <div className="space-y-3">
              ...
              {[
                ...
                <div key={i} className="bg-white rounded-xl border border-slate-200 p-3 lg:p-4 flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#0f2847]/10 rounded-lg flex items-center justify-center text-[#c5a044] shrink-0">
                    <span className="material-icons-outlined">{med.icon}</span>
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-start">
                      <h4 className="text-sm font-bold truncate">{med.nombre}</h4>
                      <span className="text-[10px] font-bold text-[#c5a044] shrink-0 ml-2">Activo</span>
                    </div>
        ...
        <aside className="w-96 border-l border-slate-200 bg-white overflow-y-auto hidden xl:block shrink-0">
          <div className="sticky top-0 bg-white z-10 px-6 py-4 border-b border-slate-200 flex items-center justify-between">
            ...
            <span className="w-2 h-2 rounded-full bg-[#0f2847] animate-pulse"></span>
          </div>
          <div className="p-6">
            <SafetyPanel />
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <div className="flex flex-wrap items-center gap-4 lg:gap-8">
            <label className="inline-flex items-center cursor-pointer">
              ...
              <div className="w-9 h-5 bg-slate-200 rounded-full peer peer-checked:bg-[#0f2847] after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:after:translate-x-full relative"></div>
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            ...
            <button className="flex-1 sm:flex-none bg-[#0f2847] text-slate-900 px-4 lg:px-8 py-2.5 rounded-lg text-xs lg:text-sm font-bold hover:shadow-lg transition flex items-center justify-center gap-2">
  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      ...
      <div>
        ...
        <div className="bg-[#0f2847]/5 border border-[#0f2847]/20 p-3 lg:p-4 rounded-xl flex items-center gap-3">
          <span className="material-icons-outlined text-[#c5a044] text-xl">check_circle</span>
      ...
      <div className="bg-slate-50 p-3 lg:p-4 rounded-xl border border-slate-200">
        ...
        <div className="flex items-center justify-between text-[11px]">
          ...
          <span className="text-[#c5a044] font-bold">EN STOCK</span>
        </div>
